...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg">Forget my password!! </p>

    <form  method="post">
      {!!csrf_field()!!}
      <div class="form-group has-feedback">
        <input type="email" class="form-control" placeholder="Email" name="email" valu="{{$data->email}}">
      ...
      <div class="form-group has-feedback">
          ...
          <div class="form-group has-feedback">
                <input type="password" class="form-control" placeholder="Password confirmation" name="passconfirm">
                <span class="glyphicon glyphicon-lock form-control-feedback"></span>
        </div>   
      
      <div class="row">
        <!--<div class="col-xs-6">
        <a href="{{aurl('login')}}" class="btn btn-info btn-block btn-flat">login</a>
        </div>
         -->
        <div class="col-xs-6">
